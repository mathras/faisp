...
--
-- Host: localhost
-- Tempo de geração: 25-Set-2024 às 01:03
...
CREATE TABLE `filmes` (
  ...
  `genero` enum('acao','drama','comedia','fantasia','suspense','terror') NOT NULL,
  `dataDeLancamento` date DEFAULT NULL,
  `classificacao` int(11) NOT NULL DEFAULT 0,
  `diretor` varchar(125) DEFAULT NULL,
...
INSERT INTO `filmes` (`id`, `titulo`, `genero`, `dataDeLancamento`, `classificacao`, `diretor`, `descricao`, `created_at`, `created_by`, `updated_at`, `updated_by`, `deleted_at`, `deleted_by`) VALUES
(1, 'dsadsadsa', 'acao', '2000-01-01', 10, NULL, 'dsadsadsada', '2024-09-13 00:54:13', 1, NULL, NULL, NULL, NULL),
(2, 'cafasdfsadada', 'comedia', '2000-01-01', 31, '1231321', '213213131 ', '2024-09-16 19:30:53', 1, NULL, NULL, NULL, NULL),
(3, 'dasfasasa', 'drama', '2000-05-05', 12, '3231231', '21313213', '2024-09-16 19:31:04', 1, NULL, NULL, NULL, NULL),
(4, '213131', 'drama', '2090-09-09', 412, 'e4321412', '214421', '2024-09-16 19:31:16', 1, NULL, NULL, NULL, NULL);
